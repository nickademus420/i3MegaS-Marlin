...
#define STRING_CONFIG_H_AUTHOR "(William Miller, i3MegaS Turbo)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "I3MS Turbo 1.4"
 ...
 */
//#define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN      //Commented out, don't use a zmin probe like a CR touch
 ...
 */
#define FILAMENT_RUNOUT_SENSOR                            //turned on filament runout sensor
#if ENABLED(FILAMENT_RUNOUT_SENSOR)
  #define FIL_RUNOUT_ENABLED_DEFAULT false // Enable the sensor on startup. Override with M412 followed by M500. I changed this from true to false.
  #define NUM_RUNOUT_SENSORS   1          // Number of sensors, up to one per extruder. Define a FIL_RUNOUT#_PIN for each.

  #define FIL_RUNOUT_STATE     HIGH        // Pin state indicating that filament is NOT present.       I changed this from LOW to HIGH
 ...
 */
#define SDSUPPORT     //turned on SD support for my lcd screen BTT mini 12864
...
//
#define STARTUP_TUNE { 500, 660, 500, 660, 500, 350, 150, 500,350,0}// 0, 150, 0, 1000, 0, 0, 500, 0, 500, 0, 500, 0, 350, 0, 150, 0, 500, 0, 350, 0, 150, 0, 1000, 0, 0}
